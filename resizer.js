...
var Resizer = (function () {
    function Resizer(src, width, height) {
    ...
    Resizer.prototype.__stepDown = function (sourceWidth, sourceHeight, targetWidth, targetHeight) {
    ...
    Resizer.prototype.__resize = function (sourceWidth, sourceHeight, stepdown) {
    ...
    Resizer.prototype.render = function (smoothing, stepdown) {
        //render canvas off-screen for performance.
        if (smoothing === void 0) { smoothing = true; }
        if (stepdown === void 0) { stepdown = true; }
    ...
    Resizer.prototype.insert = function (element) {
